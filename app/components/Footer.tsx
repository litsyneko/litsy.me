...
export default function Footer() {
  return (
    <footer className="w-full flex justify-center mt-12">
      <div className="max-w-6xl w-full mx-4 bg-white/6 backdrop-blur-sm md:backdrop-blur-md border border-white/10 rounded-xl px-6 py-4 flex items-center justify-between text-sm">
