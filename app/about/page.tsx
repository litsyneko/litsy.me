...
export default function AboutPage() {
  ...
  return (
    ...
    <div className="theme-personal min-h-screen relative overflow-hidden">
      <div className="relative z-10 pt-16 pb-12">
        {/* Enhanced Hero Section */}
        <section ref={heroRef} className="full-bleed relative py-16 sm:py-24 px-4 overflow-hidden">
