      ...
      <div className="relative z-10 pt-16 pb-12">
        ...
        <section ref={heroRef} className="relative py-16 px-4 overflow-hidden">
          ...
          <motion.div
            ...
            className="bg-card/90 dark:bg-card/80 backdrop-blur-lg border border-border/80 dark:border-border/40 rounded-2xl p-8 mb-8 shadow-lg dark:shadow-2xl dark:shadow-primary/10"
          >
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-1 -right-1 w-8 h-8 bg-emerald-500 rounded-full border-4 border-background flex items-center justify-center shadow-lg">
              ...
              <div className="flex-1 text-center md:text-left">
                <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
                  <h1 className="text-3xl font-bold">Litsy</h1>
                ...
                <p className="text-lg text-muted-foreground mb-3">
                  "2020년 Discord 봇 개발에 푹 빠져 시작된 여정이 지금의 저를 만들었습니다."<br />
                  Team Alpha부터 현재 팀 HaruCream까지, 끊임없이 성장하는 대학생 개발자입니다.
                </p>
                
                <div className="relative bg-gradient-to-r from-primary/8 via-primary/5 to-secondary/8 dark:from-primary/15 dark:via-primary/10 dark:to-secondary/15 border border-primary/30 dark:border-primary/25 rounded-xl p-4 mb-4 backdrop-blur-lg shadow-md dark:shadow-xl">
                  ...
                  <div className="relative flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="text-foreground font-semibold text-sm tracking-wide">프로필 커미션 진행 중</h4>
                      ...
                      <div className="text-xs text-muted-foreground space-y-0.5">
                        <div>📅 2025.09.04 커미션 신청 완료</div>
                        <div>🎨 현재 임시 프로필 사용 중</div>
                        <div>⏳ 최종 결과물 대기 중</div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <motion.div
                ...
                className="bg-card/60 dark:bg-card/40 backdrop-blur-md border border-border/60 dark:border-border/50 rounded-xl p-6 text-center hover:bg-card/80 dark:hover:bg-card/60 transition-all duration-300 shadow-md dark:shadow-lg hover:shadow-lg dark:hover:shadow-xl hover:border-primary/50 dark:hover:border-primary/40"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {personalValues.map((value, index) => (
              <motion.div
                ...
                className="bg-card/70 dark:bg-card/60 backdrop-blur-md border border-border/70 dark:border-border/40 rounded-xl p-6 text-center hover:border-primary/40 dark:hover:border-primary/35 transition-all duration-300 group shadow-md dark:shadow-xl hover:shadow-lg dark:hover:shadow-2xl"
              >
                <div className="w-12 h-12 mx-auto mb-4 bg-primary/10 rounded-full flex items-center justify-center text-primary group-hover:bg-primary/20 transition-colors">
                  {value.icon}
                </div>
        ...
        <section ref={experienceRef} className="py-16">
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <div className="absolute left-8 md:left-1/2 md:transform md:-translate-x-0.5 top-0 bottom-0 w-1 bg-gradient-to-b from-primary/60 via-primary/40 via-secondary/40 to-transparent rounded-full"></div>
            <div className="absolute left-8 md:left-1/2 md:transform md:-translate-x-0.5 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-primary/80 via-secondary/80 to-transparent rounded-full"></div>
              ...
              >
                ...
                <div className="absolute left-8 md:left-1/2 md:transform md:-translate-x-1/2 z-10">
                  <div className="relative w-6 h-6">
                    <div className="absolute inset-0 bg-primary rounded-full border-4 border-background shadow-lg"></div>
                    <div className="absolute inset-0 bg-primary/20 rounded-full animate-ping"></div>
                    <div className="absolute inset-1 bg-gradient-to-br from-primary to-primary/80 rounded-full"></div>
                  </div>
                </div>
                
                {/* Enhanced Year Badge */}
                <div className="absolute left-16 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-10 z-20">
                  <Badge className="bg-gradient-to-r from-primary to-primary/90 text-primary-foreground font-bold px-4 py-2 text-sm shadow-lg border border-primary/20 backdrop-blur-sm">
                    {exp.year}
                  </Badge>
                </div>
                ...
                <div className={`w-full md:w-5/12 ml-20 md:ml-0 ${
                  ...
                  <div className="bg-card/80 dark:bg-card/70 backdrop-blur-lg border border-border/60 dark:border-border/40 rounded-xl p-6 hover:border-primary/40 dark:hover:border-primary/35 transition-all duration-300 hover:shadow-lg dark:hover:shadow-xl group shadow-md dark:shadow-lg">
                    <div className="flex items-center gap-3 mb-4">
                      <div className={`p-2 bg-gradient-to-br ${exp.color} rounded-lg text-white`}>
                        {exp.icon}
                      </div>
                      <div>
                    ...
                    <div className="space-y-3">
                      <div className="flex flex-wrap gap-1">
                        {exp.tech.map((tech, techIndex) => (
                          <Badge key={techIndex} variant="outline" className="text-xs bg-background/90 dark:bg-background/70 border-border/80 dark:border-border/50 text-foreground hover:border-primary/50 dark:hover:border-primary/45 hover:bg-primary/8 dark:hover:bg-primary/15 transition-colors">
                            {tech}
                          </Badge>
                        ))}
                      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {Object.entries(skills).map(([category, data], categoryIndex) => (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-card/80 dark:bg-card/70 backdrop-blur-lg border border-border/70 dark:border-border/40 rounded-xl p-6 h-full hover:border-primary/40 dark:hover:border-primary/35 hover:bg-card/90 dark:hover:bg-card/80 transition-all duration-300 group-hover:shadow-lg dark:group-hover:shadow-xl group-hover:shadow-primary/5 dark:group-hover:shadow-primary/15 shadow-md dark:shadow-lg">
                  <div className="text-center mb-6">
                    <div className={`w-12 h-12 mx-auto mb-4 bg-gradient-to-br ${data.color} rounded-xl flex items-center justify-center text-white shadow-lg group-hover:shadow-xl transition-shadow duration-300`}>
                      {data.icon}
                    </div>
        ...
        <section ref={philosophyRef} className="py-16">
          ...
          >
            <div className="max-w-5xl mx-auto bg-gradient-to-br from-card/90 via-card/80 to-card/70 dark:from-card/80 dark:via-card/70 dark:to-card/60 backdrop-blur-xl border border-border/80 dark:border-border/40 rounded-2xl p-12 shadow-2xl dark:shadow-3xl relative overflow-hidden">
