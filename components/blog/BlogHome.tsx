...
import BlogHero from './BlogHero' // BlogHero 컴포넌트 임포트
              ...
              <div className="text-xs text-muted-foreground text-center sm:text-left">
                {authStatus.hasPermission ? (
                  <span className="text-green-600 dark:text-green-400">
                    ✓ {authStatus.user.display_name || authStatus.user.username}님, 글을 작성할 수 있습니다.
                  </span>
                ) : (
          ...
          <div className="flex-shrink-0">
            {!authLoading && (
              authStatus.hasPermission ? (
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-muted text-muted-foreground rounded-lg text-sm cursor-not-allowed">
